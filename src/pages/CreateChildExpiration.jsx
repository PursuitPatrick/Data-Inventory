...
const CreateChildExpiration = () => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-2">Create Child SKUs (Expiration)</h1>
      <p className="text-sm text-gray-600 mb-6">
        Upload a file to create child SKUs with expiration data
      </p>
...
export default CreateChildExpiration 