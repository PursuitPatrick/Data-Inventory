...
const ToolsLayout = ({ children }) => {
  ...
  const options = [
    { label: 'System Tools', path: '/tools/system' },
    { label: 'Data Import', path: '/tools/import' },
    { label: 'Data Export', path: '/tools/export' },
    { label: 'Reports', path: '/tools/reports' }
  ]
